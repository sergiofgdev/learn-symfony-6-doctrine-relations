...
class getConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Zenstruck\\Foundry\\Configuration'] = $instance = new \Zenstruck\Foundry\Configuration([], [], 'schema', []);
        ...
        $instance->setModelFactoryManager(new \Zenstruck\Foundry\ModelFactoryManager(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['App\\Factory\\QuestionFactory'] ?? ($container->privates['App\\Factory\\QuestionFactory'] = new \App\Factory\QuestionFactory()));
        }, 1)));
